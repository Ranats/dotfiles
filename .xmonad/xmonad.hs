...
main = do
    ...
    xmonad $ ewmh defaultConfig
      ...
      , ("M-k"    , windows W.focusUp)
       ...
       , ("M-p", spawn "exe=`dmenu_run -l 0 -fn 'Ricty:size=10'` && exec $exe")
       ...
       , ("<XF86AudioRaiseVolume>", spawn "amixer set Master 5%+")--"sound_volume_change_wrapper.sh +")
       , ("<XF86AudioLowerVolume>", spawn "amixer set Master 5%-")
       , ("<XF86AudioMute>"       , spawn "amixer -D pulse set Master 1+ toggle")--"sound_volume_change_wrapper.sh m")
        -- Brightness Keys
